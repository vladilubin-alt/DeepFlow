...
export declare abstract class SuperwallDelegate {
    ...
    abstract handleLog(level: string, scope: string, message?: string, info?: Map<string, any>, error?: string): void;
}
//# sourceMappingURL=SuperwallDelegate.d.ts.map